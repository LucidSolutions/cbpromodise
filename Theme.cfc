...
component{
	// Layout Variables
    this.name       	= "Promodise";
	this.description 	= "Promodise is a Bootstrap 4 template based on HTML5 and CSS3";
	this.version		= "1.0.0";
	...
	this.settings = [
		...
		{ name="footerAboutBox", group="Footer", defaultValue="", type="textarea", label="Footer About Text:", groupIntro="Customize the footer of your site."  },
		{ name="AddressBox", group="Footer", defaultValue="", type="textarea", label="Address:" },
		{ name="sitePhoneBox", group="Footer", defaultValue="", type="text", label="Site Phone No:" },
		{ name="siteEmailBox", group="Footer", defaultValue="", type="text", label="Site Email:" },
		{ name="officeAddress", group="Contact", defaultValue="", type="textarea", label="Office Address" },
		{ name="contactInfo", group="Contact", defaultValue="", type="text", label="Contact Info" },
		{ name="contactMail", group="Contact", defaultValue="", type="text", label="Contact Mail" },
		{ name="contactwebsite", group="Contact", defaultValue="", type="text", label="Contact Website" },
